...
static int \mbox{\hyperlink{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_a141775c9d96926568e5dcee9efe97427}{Read\+From\+File}} (const std\+::string path\+To\+File, aws\+\_\+byte\+\_\+buf $\ast$data, size\+\_\+t size)
\begin{DoxyCompactList}\small\item\em Reads data of size into buffer. \end{DoxyCompactList}\item 
static int \mbox{\hyperlink{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_ac8d5b0757c20c0dedf20134e6295af57}{Write\+To\+File}} (const std\+::string path\+To\+File, const aws\+\_\+byte\+\_\+buf $\ast$data)
\begin{DoxyCompactList}\small\item\em Write data into file in append mode. \end{DoxyCompactList}\item 
...
\item 
static bool \mbox{\hyperlink{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_a1e904b4aee49438c862cf547593d6698}{Directory\+Exists}} (const std\+::string \&dir\+Path)
\begin{DoxyCompactList}\small\item\em Check if the path exists and refers to a directory. \end{DoxyCompactList}\item 
static bool \mbox{\hyperlink{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_adf6b38449dbbdef62e6359fe708f59e4}{Create\+Empty\+File\+With\+Permissions}} (const std\+::string \&filename, mode\+\_\+t permissions)
\begin{DoxyCompactList}\small\item\em Create an empty file with the given permissions. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Check if the given filename exists. \end{DoxyCompactList}\item 
static bool \mbox{\hyperlink{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_a80cee4bf7b7a63656ac6f28b77926a3f}{Is\+Valid\+File\+Path}} (const std\+::string \&file\+Path)
\begin{DoxyCompactList}\small\item\em Check if the given filepath is valid. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\end{DoxyReturn}
\mbox{\Hypertarget{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_adf6b38449dbbdef62e6359fe708f59e4}\label{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_adf6b38449dbbdef62e6359fe708f59e4}} 
\index{Aws::Iot::DeviceClient::Util::FileUtils@{Aws::Iot::DeviceClient::Util::FileUtils}!CreateEmptyFileWithPermissions@{CreateEmptyFileWithPermissions}}
\index{CreateEmptyFileWithPermissions@{CreateEmptyFileWithPermissions}!Aws::Iot::DeviceClient::Util::FileUtils@{Aws::Iot::DeviceClient::Util::FileUtils}}
\doxysubsubsection{\texorpdfstring{CreateEmptyFileWithPermissions()}{CreateEmptyFileWithPermissions()}}
{\footnotesize\ttfamily bool File\+Utils\+::\+Create\+Empty\+File\+With\+Permissions (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{filename,  }\item[{mode\+\_\+t}]{permissions }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}



Create an empty file with the given permissions. 


\begin{DoxyParams}{Parameters}
{\em filename} & the path to the file \\
\hline
{\em permissions} & the permission mask that should be applied to the file \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
true if the file was successfully created with the given permissions, false otherwise 
\end{DoxyReturn}
\mbox{\Hypertarget{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_a1e904b4aee49438c862cf547593d6698}\label{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_a1e904b4aee49438c862cf547593d6698}} 
\index{Aws::Iot::DeviceClient::Util::FileUtils@{Aws::Iot::DeviceClient::Util::FileUtils}!DirectoryExists@{DirectoryExists}}
\index{DirectoryExists@{DirectoryExists}!Aws::Iot::DeviceClient::Util::FileUtils@{Aws::Iot::DeviceClient::Util::FileUtils}}
\doxysubsubsection{\texorpdfstring{DirectoryExists()}{DirectoryExists()}}
{\footnotesize\ttfamily bool File\+Utils\+::\+Directory\+Exists (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{dir\+Path }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}



Check if the path exists and refers to a directory. 
...
\begin{DoxyParams}{Parameters}
{\em filename} & File Path to the Filename to check \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\end{DoxyReturn}
\mbox{\Hypertarget{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_a80cee4bf7b7a63656ac6f28b77926a3f}\label{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_a80cee4bf7b7a63656ac6f28b77926a3f}} 
\index{Aws::Iot::DeviceClient::Util::FileUtils@{Aws::Iot::DeviceClient::Util::FileUtils}!IsValidFilePath@{IsValidFilePath}}
\index{IsValidFilePath@{IsValidFilePath}!Aws::Iot::DeviceClient::Util::FileUtils@{Aws::Iot::DeviceClient::Util::FileUtils}}
\doxysubsubsection{\texorpdfstring{IsValidFilePath()}{IsValidFilePath()}}
{\footnotesize\ttfamily bool File\+Utils\+::\+Is\+Valid\+File\+Path (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{file\+Path }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}



Check if the given filepath is valid. 


\begin{DoxyParams}{Parameters}
{\em file\+Path} & File\+Path to check \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\end{DoxyReturn}
\mbox{\Hypertarget{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_a141775c9d96926568e5dcee9efe97427}\label{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_a141775c9d96926568e5dcee9efe97427}} 
\index{Aws::Iot::DeviceClient::Util::FileUtils@{Aws::Iot::DeviceClient::Util::FileUtils}!ReadFromFile@{ReadFromFile}}
\index{ReadFromFile@{ReadFromFile}!Aws::Iot::DeviceClient::Util::FileUtils@{Aws::Iot::DeviceClient::Util::FileUtils}}
\doxysubsubsection{\texorpdfstring{ReadFromFile()}{ReadFromFile()}}
{\footnotesize\ttfamily int File\+Utils\+::\+Read\+From\+File (\begin{DoxyParamCaption}\item[{const std\+::string}]{path\+To\+File,  }\item[{aws\+\_\+byte\+\_\+buf $\ast$}]{data,  }\item[{size\+\_\+t}]{size }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}



Reads data of size into buffer. 


\begin{DoxyParams}{Parameters}
{\em path\+To\+File} & Path to a file \\
\hline
{\em data} & Buffer to contain data \\
\hline
...
\end{DoxyReturn}
\mbox{\Hypertarget{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_ac8d5b0757c20c0dedf20134e6295af57}\label{class_aws_1_1_iot_1_1_device_client_1_1_util_1_1_file_utils_ac8d5b0757c20c0dedf20134e6295af57}} 
\index{Aws::Iot::DeviceClient::Util::FileUtils@{Aws::Iot::DeviceClient::Util::FileUtils}!WriteToFile@{WriteToFile}}
\index{WriteToFile@{WriteToFile}!Aws::Iot::DeviceClient::Util::FileUtils@{Aws::Iot::DeviceClient::Util::FileUtils}}
\doxysubsubsection{\texorpdfstring{WriteToFile()}{WriteToFile()}}
{\footnotesize\ttfamily int File\+Utils\+::\+Write\+To\+File (\begin{DoxyParamCaption}\item[{const std\+::string}]{path\+To\+File,  }\item[{const aws\+\_\+byte\+\_\+buf $\ast$}]{data }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [static]}}



Write data into file in append mode. 


\begin{DoxyParams}{Parameters}
{\em path\+To\+File} & Path to a file \\
\hline
{\em data} & Buffer containing data \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
0 on success 
